...
if ($conexion->connect_error) {
    die("Error al comprobar la tabla festival_cortos: " . $conexion->error);
}
...
if ($comprobar->num_rows <= 0) {
    ...
    -- HISTORIAL CANDIDATURA (5)
    INSERT INTO historial_candidatura (id_candidatura, estado, motivo, fecha_hora) VALUES
    (1, 'En revisión', 'Pendiente jurado', NOW()),
    (2, 'Aceptada', 'Alta calidad', NOW()),
    (3, 'Rechazada', 'No cumple bases', NOW()),
    (4, 'Aceptada', 'Excelente guion', NOW()),
    (5, 'En revisión', 'Documentación incompleta', NOW());
    ...
    -- PREMIO_CANDIDATURA (5)
    INSERT INTO premio_candidatura (id_premio, id_candidatura, fecha_hora) VALUES
    (1, 1, NOW()),
    (2, 2, NOW()),
    (3, 3, NOW()),
    (4, 4, NOW()),
