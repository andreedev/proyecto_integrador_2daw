const faqData = [
    {
        ...
        answer: "Pueden participar alumnos actuales de Ciclos Formativos, Grado o Máster de la UE. También antiguos alumnos(Alumni) que se hayan graduado en 2024/2025 (Categoría UE) o en los últimos cinco cursos académicos desde el 2019/2020 (Categoría Alumni)."
    },
    {
    ...
    },
    {
        ...
        answer: "Para que tu corto se vea perfecto en la gala, debe cumpplir estos requisitos:"+"<br>"+
            "Formato: QuickTime MOV (H.264) o MP4. " + "<br>"+
            "Resolución: 1920X1080p a 25 fps. " + "<br>"+
